...
parser.add_argument('--datapath', default='/home/hanrufeng/dataset/28/4/', help='data path')
...
def train():
    ...
    model = models.resnet50(num_classes=103)  # 调用内置模型
    ...
    for epoch in range(args.epochs):
        ...
        for batch, (batch_x, batch_y) in enumerate(train_loader):
            ...
            train_loss1 += abs(loss.item()) * num1
            train_num += num1
        ...
        train_loss_all.append(train_loss1 / train_num)
        train_accur_all.append(train_acc / train_num)
        # evaluation--------------------------------
        model.eval()
        eval_loss = 0
        eval_acc = 0
        ...
        test_loss_all.append(eval_loss1 / eval_num)
        test_accur_all.append(eval_acc / eval_num)
